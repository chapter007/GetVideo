...
public class ConfigUtils {
	...
	public static final String PREFERENCE_NAME = "com.zhangjie.downloader";
    ...
    public static void setVideoName(Context context,String key,String value){
        setString(context,key,value);
    }

    public static String getVideoName(Context context,String key){
